...
path <- "D:/Uni_Semester/Semester 10/Mid/Data Science/Lab/Midterm_Project_Dataset_section(A).csv"
data <- read.csv(path)

missmap(data, main = "Missing Values Map")

dataset <- read_csv("D:/Uni_Semester/Semester 10/Mid/Data Science/Lab/Midterm_Project_Dataset_section(A).csv")
